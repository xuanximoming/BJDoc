...
public class AsycDownloadTask extends AsyncTask<DownloadTask, Integer, DownloadTask> {
    ...
    /*private static final String STORE_PATH = Environment.getExternalStorageDirectory().getPath()+File.separator+"snowdream/android/downloader/";*/
    private static final String STORE_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath()+File.separator+".dl/apk/";
