...
/**
 * 
* @ClassName: NurseGButAdapter 
* @Description: TODO(护理模块) 
* @author lll
* @date 2013-12-20 上午10:51:25 
*
 */
public class NurseGButAdapter extends BaseAdapter{
	...
	private String[] textArr = { "生命体征", "每日评估", "住院评估"};
	
	
	public NurseGButAdapter(Context context){
