...
/**
 * 
* @ClassName: AddInspectionActivity 
...
public class AddInspectionActivity extends Activity implements OnClickListener{
	...
	private SearchFragment searchFm;//检索界面
		...
		case R.id.common_but_ok:
            ...
            .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                	...
                	//调用检验AddInspectionFragment中的函数，判断必填项是否完成，完成则执行插入任务
                	if (leftFm.validate()) {
	...
	*
	...
	private class InsertInspectionTask extends AsyncTask<Void, Void, String>{
		...
		protected String doInBackground(Void... params) {
			// TODO Auto-generated method stub
			leftFm.insert();//调用检验AddInspectionFragment中的函数insert()
			return null;
		}
		...
		protected void onPostExecute(String result) {
			...
			setResult(13, intent); //返回MainActivity中的onActivityResult（）函数
			finish();
		}
	}
