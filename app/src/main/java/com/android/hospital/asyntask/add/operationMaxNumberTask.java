...
/**
 * 
* @ClassName: operationMaxNumberTask 
* @Description: TODO(最大序号) 
* @author lll 
* @date 2013-03-09
*
 */
public class operationMaxNumberTask extends AsyncTask<String, Void, String>{
	...
	public operationMaxNumberTask(Context context){
